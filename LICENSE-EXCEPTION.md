# Licensing notes for Feature Layer

Feature Layer is licensed under the **[GNU Affero General Public License v3.0 or
...
>
> As a special exception, the copyright holders of Feature Layer give you permission to
> combine, link with, and distribute Feature Layer, or a work based on Feature Layer, together
...
> resulting work that are Feature Layer, or a work based on Feature Layer.
>
...
**If you only install and use Feature Layer, none of this touches you.** Running the
...
- `app/src/main/java/com/atakmap/android/featurelayer/plugin/PluginNativeLoader.java`
...
- `app/src/main/java/com/atakmap/android/featurelayer/plugin/FeatureLayer.java`
- `app/src/main/java/com/atakmap/android/featurelayer/plugin/FeatureLayerPreferenceFragment.java`
